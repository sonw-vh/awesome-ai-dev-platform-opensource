...
export const defaultTheme = generateTheme({
    primaryColor: '#6e41e2',
    websiteName: 'AIxBlock',
    fullLogoUrl: 'https://aixblock.io/assets/images/logo-img.svg',
    favIconUrl: 'https://aixblock.io/assets/images/logo-img.svg',
    logoIconUrl: 'https://aixblock.io/assets/images/logo-img.svg',
})
