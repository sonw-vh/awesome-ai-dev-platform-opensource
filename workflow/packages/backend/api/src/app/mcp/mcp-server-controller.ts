...
import { ALL_PRINCIPAL_TYPES, ApId, apId, ListMcpsRequest, McpWithBlocks, PrincipalType, ProjectId, SeekPage, SERVICE_KEY_SECURITY_OPENAPI } from 'workflow-shared'
...
const GetMcpsRequest = {
    ...
    schema: {
        ...
        response: {
            [StatusCodes.OK]: SeekPage(McpWithBlocks),
        },
    },
}
