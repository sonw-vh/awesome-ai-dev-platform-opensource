...
import { AppSystemProp, BlocksSource, ContainerType, environmentVariables, pinoLogging, SystemProp, WorkerSystemProp } from 'workflow-server-shared'
import {
    AIxBlockError,
    ApEdition,
    BlockSyncMode,
...
const systemPropDefaultValues: Partial<Record<SystemProp, string>> = {
    ...
    [AppSystemProp.CONFIG_PATH]: path.join(os.homedir(), '.axbworkflows'),
    ...
    [AppSystemProp.BLOCKS_SYNC_MODE]: BlockSyncMode.OFFICIAL_AUTO,
    ...
    [AppSystemProp.BLOCKS_SOURCE]: BlocksSource.DB,
    ...
    [AppSystemProp.SHOW_CHANGELOG]: 'false',
}
