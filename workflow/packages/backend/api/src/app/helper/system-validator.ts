...
import { AppSystemProp, BlocksSource, ContainerType, SystemProp, WorkerSystemProp } from 'workflow-server-shared'
import { ApEdition, ApEnvironment, BlockSyncMode, ExecutionMode, FileLocation, isNil } from 'workflow-shared'
...
const systemPropValidators: {
    ...
    [AppSystemProp.BLOCKS_SOURCE]: enumValidator(Object.values(BlocksSource)),
    ...
    [AppSystemProp.DEV_BLOCKS]: stringValidator,
    ...
    [AppSystemProp.BLOCKS_SYNC_MODE]: enumValidator(Object.values(BlockSyncMode)),
    ...
    // AIxBlock
    [AppSystemProp.AIXBLOCK_CLIENT_ID]: stringValidator,
    [AppSystemProp.AIXBLOCK_CLIENT_SECRET]: stringValidator,
    [AppSystemProp.AIXBLOCK_PLATFORM_URI]: stringValidator,
}
