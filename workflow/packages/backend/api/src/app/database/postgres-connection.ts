...
import { AddTokenIntoUserIdentity1745562330000 } from './migration/common/1745562330000-AddTokenIntoUserIdentity'
import { AddUrlIntoUserIdentity1745565816000 } from './migration/common/1745565816000-AddUrlIntoUserIdentity'
...
import { AddProjectIdToAiProvider1744187975994 } from './migration/postgres/1744187977994-AddProjectIdToAiProvider'
import { ExpandStoreEntryLeyLength1744187978994 } from './migration/postgres/1744187978994-ExpandStoreEntryKeyLength'
import { AddMcpPiece1744822233873 } from './migration/postgres/1744822233873-AddMcpPiece'
import { AddMetadataForFlowTemplate1744836784953 } from './migration/postgres/1744836784953-AddMetadataForFlowTemplate'
import { AddListingFlow1746515592000 } from './migration/postgres/1746515592000-AddListingFlow'
import { AddListingPreviewCol1746602411215 } from './migration/postgres/1746602411215-AddListingPreviewCol'
import { AddListingUserIdCol1746689195873 } from './migration/postgres/1746689195873-AddListingUserIdCol'
import { AddListingCategory1746689881279 } from './migration/postgres/1746689881279-AddListingCategory'
import { AddListingCategory1746771085000 } from './migration/postgres/1746771085000-AddListingCategory'
import { CreateTableCopilot1747103524914 } from './migration/postgres/1747103524914-CreateTableCopilot'
import { DeletePlatformCopilotSettings1747119262467 } from './migration/postgres/1747119262467-DeletePlatformCopilotSettings'
import { RenamePieceMetadataFromPieceToBlock1747384077914 } from './migration/postgres/1747384077914-RenamePieceMetadataFromPieceToBlock'
import { MigrationBlockTypeInTriggerInFlowVersion1747387033987 } from './migration/postgres/1747387033987-MigrationBlockTypeInTriggerInFlowVersion'
import { RenameToBlockTag1747627083208 } from './migration/postgres/1747627083208-RenameToBlockTag'
import { RenameToMcpBlock1747629422575 } from './migration/postgres/1747629422575-RenameToMcpBlock'
import { RenamePieceInAppConnection1747634348069 } from './migration/postgres/1747634348069-RenamePieceInAppConnection'
import { UpdateBlockNameInFlowVersion1747636501783 } from './migration/postgres/1747636501783-UpdateBlockNameInFlowVersion'
import { RenamePieceInOauth1747639252948 } from './migration/postgres/1747639252948-RenamePieceInOauth'
import { RenamePieceInFlowTemplate1747639844125 } from './migration/postgres/1747639844125-RenamePieceInFlowTemplate'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const commonMigration = [
        ...
        AddTokenIntoUserIdentity1745562330000,
        AddUrlIntoUserIdentity1745565816000,
        AddMcpPiece1744822233873,
        AddProjectIdToAiProvider1744187975994,
        ExpandStoreEntryLeyLength1744187978994,
        AddMetadataForFlowTemplate1744836784953,
        AddListingFlow1746515592000,
        AddListingPreviewCol1746602411215,
        AddListingUserIdCol1746689195873,
        AddListingCategory1746689881279,
        AddListingCategory1746771085000,
        CreateTableCopilot1747103524914,
        DeletePlatformCopilotSettings1747119262467,
        RenamePieceMetadataFromPieceToBlock1747384077914,
        MigrationBlockTypeInTriggerInFlowVersion1747387033987,
        RenameToBlockTag1747627083208,
        RenameToMcpBlock1747629422575,
        RenamePieceInAppConnection1747634348069,
        UpdateBlockNameInFlowVersion1747636501783,
        RenamePieceInOauth1747639252948,
        RenamePieceInFlowTemplate1747639844125,
    ]
