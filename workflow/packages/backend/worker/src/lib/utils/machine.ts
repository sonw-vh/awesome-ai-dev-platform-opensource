...
import { apVersionUtil, environmentVariables, exceptionHandler, fileExists, networkUtils, webhookSecretsUtils, WorkerSystemProp } from 'workflow-server-shared'
import { assertNotNullOrUndefined, isNil, MachineInformation, spreadIfDefined, WorkerMachineHealthcheckRequest, WorkerMachineHealthcheckResponse } from 'workflow-shared'
    ...
    async getSystemInfo(): Promise<WorkerMachineHealthcheckRequest> {
        ...
        return {
            ...
            workerProps: {
                ...
                ...spreadIfDefined('BLOCKS_SOURCE', settings?.BLOCKS_SOURCE),
                ...spreadIfDefined('DEV_BLOCKS', settings?.DEV_BLOCKS?.join(',')),
