import { Store, StoreScope } from 'workflow-blocks-framework'
import { DeleteStoreEntryRequest, FlowId, isNil, PutStoreEntryRequest, STORE_KEY_MAX_LENGTH, STORE_VALUE_MAX_SIZE, StoreEntry } from 'workflow-shared'
