import { InputPropertyMap, PieceAuthProperty, PieceProperty, PiecePropertyMap, PropertyType, StaticPropsValue } from 'workflow-blocks-framework'
import { AUTHENTICATION_PROPERTY_NAME, isNil, isObject } from 'workflow-shared'
import { z } from 'zod'
