import { ExecuteFlowOperation, ExecutePropsOptions, ExecuteStepOperation, ExecuteToolOperation, ExecuteTriggerOperation, ExecutionType, FlowVersionState, ProgressUpdateType, Project, ProjectId, ResumePayload, TriggerHookType } from 'workflow-shared'
...
export class EngineConstants {
    ...
    public static readonly PIECE_SOURCES = process.env.AP_BLOCKS_SOURCE ?? 'FILE'
