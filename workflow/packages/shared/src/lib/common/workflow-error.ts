...
export class AIxBlockError extends Error {
...
export type InvalidCloudClaimParams = BaseErrorParams<ErrorCode.INVALID_CLOUD_CLAIM, { blockName: string }>
...
export type BadRequestParams = BaseErrorParams<
ErrorCode.BAD_REQUEST,
{
    message: string
}
>
export type NotFoundParams = BaseErrorParams<
ErrorCode.NOT_FOUND,
{
    message: string
}
>
export type McpPieceRequiresConnectionParams = BaseErrorParams<ErrorCode.MCP_BLOCK_REQUIRES_CONNECTION, {
    blockName: string
}>

export type McpPieceConnectionMismatchParams = BaseErrorParams<ErrorCode.MCP_BLOCK_CONNECTION_MISMATCH, {
    blockName: string
    connectionBlockName: string
    connectionId: string
}>
export enum ErrorCode {
    ...
    NOT_FOUND = 'NOT_FOUND',
    MCP_BLOCK_REQUIRES_CONNECTION = 'MCP_BLOCK_REQUIRES_CONNECTION',
    MCP_BLOCK_CONNECTION_MISMATCH = 'MCP_BLOCK_CONNECTION_MISMATCH',
}
