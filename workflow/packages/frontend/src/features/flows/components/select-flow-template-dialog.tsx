...
import { ArrowLeft, Info, Lock, Search, SearchX } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="py-2 px-4 gap-1 flex items-center">
          ...
          <TooltipTrigger asChild>
            <div className="size-10 flex justify-center items-center">
              <Button
                variant="outline"
                size="icon"
                className="hover:bg-muted cursor-pointer flex justify-center items-center"
        ...
        <CopyButton textToCopy={template.id} tooltipContent={t("Copy flow template id")} />
        {
          template.type === TemplateType.MARKETPLACE
            ? (
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="size-10 flex justify-center items-center mr-2 text-green-700">
                    <Lock className="w-4 h-4" />
                  </div>
                </TooltipTrigger>
                <TooltipContent side="bottom">
                  <span className="text-sm">{t('Bought from marketplace')}</span>
                </TooltipContent>
              </Tooltip>
            )
            : null
