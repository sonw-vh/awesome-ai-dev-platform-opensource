...
import BgCreateTodoGuide from '@/assets/img/custom/BgCreateTodoGuide.png';
import ExternalChannelTodo from '@/assets/img/custom/External_Channel_Todo.png';
import SampleTodo from '@/assets/img/custom/SampleTodo.png';
...
import { TodoType } from 'workflow-shared';
              ...
              <div className="space-y-4">
                ...
                >
                      ...
                      <Tooltip delayDuration={100}>
                        ...
                        <TooltipContent side="right" className="w-[550px]">
                          <div className="space-y-2">
                            <p className="text-sm">
                              {t(
                                'Users will manage tasks directly in AIxBlock',
                              )}
                            </p>
                            <div className="bg-muted rounded p-1">
                              <img
                                src={SampleTodo}
                                alt="AIxBlock Todo UI"
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t(
                      'Users will manage and respond to todos directly within the AIxBlock interface. Ideal for internal teams.',
                    )}
                  </p>
                </div>
              ...
              <div className="border rounded-lg overflow-hidden p-3 w-full h-full">
                <div className="flex flex-col items-center h-[480px]">
                  ...
                  <p className="text-sm text-muted-foreground italic text-center mb-2">
                    {displayImageType === TodoType.INTERNAL
                      ? t(
                          'The AIxBlock Todo allows users to review and resolve tasks directly in the AIxBlock interface',
                        )
                      : t(
