...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'relative flex h-10 w-full items-center justify-between px-[12px] py-2 whitespace-nowrap text-sm',

      // Style nền, viền, bo góc, đổ bóng
      'rounded-xs border border-input bg-transparent shadow-sm',

      // Trạng thái mặc định & placeholder
  ...
  >
    ...
    <SelectPrimitive.Icon
      asChild
      className="absolute right-[5px] text-[#111] transition-transform duration-200 group-data-[state=open]:rotate-[-90deg]"
    >
      <IconArrowLeft />
    </SelectPrimitive.Icon>
  </SelectPrimitive.Trigger>
