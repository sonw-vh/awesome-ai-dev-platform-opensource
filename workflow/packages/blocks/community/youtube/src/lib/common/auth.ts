import { PieceAuth } from 'workflow-blocks-framework';
...
export const youtubeAuth = PieceAuth.OAuth2({
  description: `
    ...
    12. Add https://workflow.aixblock.io/redirect in **Authorized redirect URIs** field, and click on the Create button.
