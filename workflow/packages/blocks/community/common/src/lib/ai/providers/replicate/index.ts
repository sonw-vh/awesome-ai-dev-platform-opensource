...
export const replicateModels = [
    ...
    model({
        label: 'bytedance/sdxl-lightning-4step',
        value: 'bytedance/sdxl-lightning-4step:5599ed30703defd1d160a25a63321b4dec97101d98b4674bcc56e41f62f35637',
        supported: ['image'],
    ...
    model({ label: 'black-forest-labs/flux-schnell', value: 'black-forest-labs/flux-schnell', supported: ['image'] }).mapper(
        imageMapper({
            advancedOptions: {},
