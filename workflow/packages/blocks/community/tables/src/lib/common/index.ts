import { AuthenticationType, httpClient, HttpMethod } from "workflow-blocks-common";
import { DynamicPropsValue, Property, TriggerHookContext } from "workflow-blocks-framework";
import { CreateTableWebhookRequest, Field, FieldType, MarkdownVariant, PopulatedRecord, SeekPage, StaticDropdownEmptyOption, Table, TableWebhookEventType } from "workflow-shared";
import { z } from 'zod';
