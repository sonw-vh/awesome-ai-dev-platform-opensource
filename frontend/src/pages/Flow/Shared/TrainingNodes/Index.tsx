...
const TrainingNodes = (props: TNodeMLProps) => {
  const {
    proxyUrl,
    masterNodes,
    workerNodes,
            ...
            <div className="joined">
              {(masterNodes.length > 0 || mlJoined.length > 0) &&
                <span className={styles.lastText}>
                  End Point: {proxyUrl ? <span className={styles.lastTextEndpoint}>{proxyUrl}</span> : "No Proxy URL available"}
                  <Button size="tiny" type="warning" className={styles.lastTextReset} onClick={resetContainer}>
                    Reset
                  </Button>
                  {masterNodes.length > 0 && (
                    <Button size="tiny" type="gradient" className={styles.lastTextReset} onClick={() => setMonitor(true)}>
                      Monitor
                    </Button>
                  )}
                </span>
              ...
              {masterNodes.length > 0 && (
                <div className={styles.masterNodes}>
