...
const sidebarItems: SidebarItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      //   icon: <IconDocument />,
      //   label: SIDEBAR_ITEM_LABELS.TEMPLATE_MARKETPLACE,
      // },
    ],
  },
  // {
  ...
  // {
  //   path: "/marketplace/computes",
  //   icon: <IconMarketplace />,
  //   label: SIDEBAR_ITEM_LABELS.MARKETPLACE,
  //   activeChecker: (path: string) => {
  ...
  },
  {
    ...
    activeChecker: (path: string) => {
      return ["/user/account", "/user/rewards", "/user/organization"].indexOf(path) > -1;
    },
    children: [
      {
        path: "/user/account",
  ...
  },
  {
    path: "/open-source/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256"><path d="M216,104v8a56.06,56.06,0,0,1-48.44,55.47A39.8,39.8,0,0,1,176,192v40a8,8,0,0,1-8,8H104a8,8,0,0,1-8-8V216H72a40,40,0,0,1-40-40A24,24,0,0,0,8,152a8,8,0,0,1,0-16,40,40,0,0,1,40,40,24,24,0,0,0,24,24H96v-8a39.8,39.8,0,0,1,8.44-24.53A56.06,56.06,0,0,1,56,112v-8a58.14,58.14,0,0,1,7.69-28.32A59.78,59.78,0,0,1,69.07,28,8,8,0,0,1,76,24a59.75,59.75,0,0,1,48,24h24a59.75,59.75,0,0,1,48-24,8,8,0,0,1,6.93,4,59.74,59.74,0,0,1,5.37,47.68A58,58,0,0,1,216,104Z"></path></svg>
    ),
    label: SIDEBAR_ITEM_LABELS.OPEN_SOURCE,
  },
  {
    path: "/open-dataset/",
    icon: (
      <svg width="20" height="20" viewBox="0 0 500 463" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    label: SIDEBAR_ITEM_LABELS.OPEN_DATASET,
  },
];
