export const HOSTNAME = '69.197.168.145';
export const PORT = 8004;
export const Default_From = 'noreply@aixblock.io'

export async function sendEmail(data: any) {
    const url = `http://${HOSTNAME}:${PORT}/api/push/email`;
...
// emailUtils.js
// from_user = no-reply@app.aixblock.io
export function getEmailData(subject: string, from_user: string, to_list_users: string[], text: string, html: string, attachments: any[]) {
    const data = {
        subject: subject,
        from: from_user,
        to: to_list_users,
