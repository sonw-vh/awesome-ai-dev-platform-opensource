...
import { TComputeMarketplace, validateComputeMarketplaceListModel } from "@/models/computeMarketplace";
...
export const useGetCompute = (
  ...
  const fetchData = useCallback(async () => {
    ...
    const response: TApiCallResult = api.call("getListCompute", {
      query
    });
