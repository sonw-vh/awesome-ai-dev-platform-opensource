...
import { ChatMessage } from "../tags/control/Chat";
...
const Result = types
  .model("Result", {
    ...
    value: types.model({
      ...
      question: types.maybe(types.model({
        question: types.string,
        answer: types.string,
        trans_id: types.string,
      })),
      languagepair: types.maybe(types.model({
        source: types.maybeNull(types.string),
        target: types.maybeNull(types.string),
      })),
      audiofile: types.maybe(types.model({
        type: types.enumeration(["url"]),
        data: types.string,
      })),
      audioredact: types.maybe(types.model({
        start: types.number,
        end: types.number,
      })),
      chat: types.array(ChatMessage),
    }),
