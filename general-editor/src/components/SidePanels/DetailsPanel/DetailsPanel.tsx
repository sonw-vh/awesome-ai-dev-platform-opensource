...
export const GeneralPanel: FC<any> = inject("store")(observer(({ store, currentEntity }) => {
    ...
    <>
      <Elem name="section">
        ...
        {showAnnotationHistory && (
          <Elem name="section-head" style={{ padding: 8 }}>
            Annotation History
...
export const RegionsPanel: FC<{regions:  any}> = observer(({
  regions,
}) => {
  return (
    <div>
