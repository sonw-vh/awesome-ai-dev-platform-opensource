...
Scenario("Drawing with ctrl pressed", async function({ I, AIxBlock, AtSidebar, AtImageView }) {
  const params = {
...
Scenario("How it works without ctrl", async function({ I, AIxBlock, AtSidebar, AtImageView }) {
  const params = {
