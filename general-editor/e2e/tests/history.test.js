...
Scenario("Travel through history with the selected brush region", async function({ I, AIxBlock, AtImageView, AtSidebar }) {
  I.amOnPage("/");
  AIxBlock.init({
    data: { image: IMAGE },
    config: `<View>
...
Scenario("Travel through history after moving the rectangle region", async function({ I, AIxBlock, AtImageView, AtSidebar }) {
  I.amOnPage("/");
  AIxBlock.init({
    data: { image: IMAGE },
    config: `<View>
